...
public class MPersonExpandableListAdapter extends BaseExpandableListAdapter {

	List<List<PersonSearchBean.PersonItemBean.WorkListDTO>> childList;
	private Context context;

	private List<String>  groupList;

	public MPersonExpandableListAdapter(Context context,
                                        List<String> groupList, List<List<PersonSearchBean.PersonItemBean.WorkListDTO>> childList) {
	 ...
	 */
	@Override
	public PersonSearchBean.PersonItemBean.WorkListDTO getChild(int groupPosition, int childPosition) {
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		child_text.setText(childList.get(groupPosition).get(childPosition).getWORKER_NAME());
